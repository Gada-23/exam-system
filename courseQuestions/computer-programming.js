...
window.computerProgrammingQuestions = [
    ...
    },
    {
        ...
        "answer": 0,
        "explanation": "A recursive function is defined as a function that calls itself during its execution.",
        "course": "Computer Programming"
    },
    {
    ...
    },
    {
        ...
        "options": [
            "A. Hold address of a single value",
            "B. Hold one value", 
            "C. Hold values of the same type under a single name",
            "D. Hold addresses of values under a single name"
        ],
        "answer": 2,
        "explanation": "Arrays are data structures that store multiple values of the same data type under a single identifier name.",
        "course": "Computer Programming"
    },
    ...
    },
    {
        ...
        "answer": 1,
        "explanation": "t is a pointer storing the address of x. Dereferencing t with *t gives the value stored at that address, which is 3.",
        "course": "Computer Programming"
    },
    {
        ...
        "answer": 1,
        "explanation": "Structures are copied by value when assigned. p2 gets a copy of p1. Changing p2.age does not affect p1.age. Output: 25 30",
        "course": "Computer Programming"
    },
    {
    ...
    {
        "question": "Given that the file output stream variable, named fileout, has been defined and opened for output, which of the following will return the current position of the file pointer?",
        "options": [
            "A. fileout.tellg()",
            "B. fileout.tellp()", 
            "C. fileout.seekg()",
        ...
        "answer": 1,
        "explanation": "tellp() returns the current position of the put pointer for output streams. tellg() is for input streams.",
        "course": "Computer Programming"
    },
    ...
    },
    {
        ...
        "answer": 0,
        "explanation": "A recursive function calls itself.",
        "course": "Computer Programming"
    },
    ...
    // New questions from Haramaya University Model Exam
    {
        ...
        "answer": 1,
        "explanation": "In C++, default arguments must be added from right to left. You cannot have a non-default parameter after a default parameter. Only option B follows this rule.",
        "course": "Computer Programming"
    },
    {
        "question": "A structure definition is a user-defined variable type which is a grouping of one or more variables. Which one of the following is not correct about structure?",
        "options": [
            "A. Once the type has been defined through the C++ 'struct' keyword, you can create variables from it just like you would any other type.",
        ...
        "answer": 1,
        "explanation": "Option B is incorrect. The structure must be defined BEFORE creating variables, not after. The definition must come first.",
        "course": "Computer Programming"
    },
    {
        "question": "Which one of the following is an operator specifically used to access structure members through a pointer?",
        "options": [
            "A. *",
            "B. .",
            "C. ->",
        ...
        "answer": 2,
        "explanation": "The arrow operator (->) is used to access members of a structure through a pointer. The dot operator (.) is used with the structure variable itself.",
        "course": "Computer Programming"
    },
    {
...
console.log(`✅ Loaded ${window.computerProgrammingQuestions.length} Computer Programming questions`);